  ...
  return (
    <div>
      ...
      <section className="pt-32 pb-24 px-6 bg-gradient-to-br from-nude via-warm-white to-blush">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-stone mb-8 leading-relaxed max-w-2xl">
              Thoughtfully designed essentials for the intentional dresser. Each piece crafted
              to last, to layer, and to matter.
            </p>
            <Link
              href="/shop"
              className="inline-block bg-ink text-warm-white px-8 py-4 font-semibold tracking-wide hover:bg-stone transition"
            >
              Shop Now
            </Link>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-ink mb-2">Featured</h2>
      ...
      <section className="py-20 px-6 bg-warm-white border-t border-nude">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-ink mb-2">Journal</h2>
